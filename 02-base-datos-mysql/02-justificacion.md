...
**Recomendación:** iniciar self-hosted en Docker dentro del mismo VPS de Hetzner (ver `../01-hosting-vps/`) y migrar a un servicio gestionado cuando se llegue a la fase de escalado (sección 11 del doc principal, >10,000 usuarios).
