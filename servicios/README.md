# Índice — Servicios de la Plataforma de Renta de Casas

Cada servicio vive en su propia carpeta, con una sección por archivo `.md`. Esta tabla resume todos los servicios; debajo hay un índice detallado con el link a cada archivo.
